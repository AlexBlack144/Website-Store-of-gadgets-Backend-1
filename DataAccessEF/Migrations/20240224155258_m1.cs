...
namespace DataAccessEF.Migrations
{
    public partial class m1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FkGadgetsId = table.Column<int>(type: "int", nullable: true),
                    FkAspNetUsersId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    UserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsLiked = table.Column<bool>(type: "bit", nullable: true),
                    IsDisliked = table.Column<bool>(type: "bit", nullable: true),
                    TimeDate = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GadgetCommentsLikeDisliks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GadgetCommentsLikeDisliks_AspNetUsers_FkAspNetUsersId",
                        column: x => x.FkAspNetUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GadgetCommentsLikeDisliks_Gadgets_FkGadgetsId",
                        column: x => x.FkGadgetsId,
                        principalTable: "Gadgets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GadgetCommentsLikeDisliks_FkGadgetsId",
                table: "GadgetCommentsLikeDisliks",
                column: "FkGadgetsId");
